import { type Protocol, type TestType, startServer, runClient } from './src/speed-test';
...
if (process.argv[2] === 'server') {
  ...
  console.log('Usage: ts-node cli.ts [server|client] [tcp|udp|websocket] [upload|download]');
}
