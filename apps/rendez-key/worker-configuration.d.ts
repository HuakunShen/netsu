/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 52844f5db6d8cc6447f3da129f7db6e9)
// Runtime types generated with workerd@1.20260721.1 2026-07-20 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	DB: D1Database;
	CREATE_LIMITER: RateLimit;
	SIGNAL_CREATE_LIMITER: RateLimit;
	PUBLIC_CREATE: "true";
	PUBLIC_SIGNAL_CREATE: "true";
	API_TOKEN: string;
	SIGNAL_ROOMS: DurableObjectNamespace<import("./src/index").SignalRoom>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "SignalRoom";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_CREATE" | "PUBLIC_SIGNAL_CREATE" | "API_TOKEN">> {}
}
